...
4. ^ НЕ обязательные поля, значения которых можно опустить
...
```
GET http://example.com/brand/get?sstr=value&keysum=value1,value2 HTTP/1.1
```
...
```
GET http://example.com/dform/get?code_or_sstr=value&keysum=value1,value2 HTTP/1.1
```
