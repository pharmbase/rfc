...
```
	data.geoapt.ua // Данные из Украины
	data.geoapt.ru // Данные из России
```
...
```
{
	"meta": {
		...
		"chk_text": "string",   // Текстовое сообщение результата проверки
	...
	"data": [{
		...
		"quant": 0.0,     // Количество (остаток) (float)
		"price": 0.0,     // Цена розничная (float)
		...
		"err_text": 0.0,    // Текстовое сообщение результата проверки
