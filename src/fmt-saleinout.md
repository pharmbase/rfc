...
```
{
	...
	"data": [{
		...
		"supp": "string", // Поставщик (название) только для sale-in
		"edrp": "string", // ЕДРПОУ (ОКПО) только для sale-in
		"quant_inp": 0.0, // Приход Количество (float)
		"price_inp": 0.0, // Приход Цена (float)
		"quant_out": 0.0, // Расход Количество (float)
		"price_out": 0.0, // Расход Цена (float)
		"balance": 0.0,   // Остаток на конец периода (float)
		"reimbur": 0,     // Возмещение 0 или 1 (int)
