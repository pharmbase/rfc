...
Название бренда/лекформы
```json
{
  "id": "",    // Уникальный идентификатор
  "name": "",  // Название бренда/лекформы
}
...
/get_drugs_by_name/{id_name}  // Поиск лекформы по идентификатору названия бренда
/get_drugs_by_char/{chars}    // Поиск лекформы по введенным символам (содержит)
/get_props_by_drug/{id_drug}  // Поиск предложений по идентификатору лекформы
/get_name_by_drug/{id_drug}   // Ппоиск названия бренда по идентификатору лекформы
```
...
Запрос возвращает список названий лекформ, содержащих введенные символы (нажали кнопку поиска). Вместо `{chars}` подставить безоопасно для урл закодированные символы.
