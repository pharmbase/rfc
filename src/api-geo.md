...
/user/:name/:pass/get  // Получить пользователя его по имени и паролю
...
```json
{
  ...
  "desc": "",        // Описание торговой сети
  "egrpou": "",      // ЕГРПОУ (ОКПО)
  "info_addr_1": {   // Информация адресная (Ю)
    "country": "",   // Страна
    "area": "",      // Область
    "region": "",    // Район
  ...
  "info_addr_2": {   // Информация адресная (Ф)
    "country": "",   // Страна
    "area": "",      // Область
    "region": "",    // Район
    "city": "",      // Населенный пункт
  ...
  "info_cont": {     // Информация контактная
  ...
  "info_lcns": {     // Информация лицензионная
    "name": "",      // Название (номер)
    "date_1": "",    // Дата 1 (начало)
    "date_2": ""     // Дата 2 (окончание)
  },
  "info_bank": {     // Информация банковская
    "acc": "",       // Расчетный счет
    "mfo": "",       // МФО
    "inn": "",       // Индивидуальный налоговый номер (ИНН)
    "reg": "",       // Номер свидетельства регистрации
    "vat": ""        // Номер свидетельства плательщика НДС
  },
  "axioma_sign": false  // Знак Аксиомы (true - заверено)
}
```
...
```json
{
  ...
  "info_desc": {      // Информация описательная
    "mode": "",       // Режим работы торговой точки
    "path": "",       // Как проехать
    "delv": "",       // Доставка|Самовывоз
    "delv_note": "",  // Описание условий доставки/самовывоза
    "book": "",       // Бронирование|Заказ
    "book_note": "",  // Описание условий бронипрования/заказа
    "disc": ""        // Описание дисконтной программы
  },
  "info_coor": {      // Информация геокоординатная
    "lat": 0,         // Широта (float64)
    "lng": 0          // Долгота (float64)
  },
  "axioma_sign": false  // Знак Аксиомы (true - заверено)
}
```
