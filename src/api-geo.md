...
```json
{
  ...
  "name": "",            // Название (торговое)
  "mark": "",            // Марка торговая
  "logo": "",            // Логотип (название файла)
  "kind": "",            // Тип (Аптека|Аптечный пункт)
  "level": 0.0,          // Уровень сервиса аптеки
  ...
  "sale_phone": "",      // Телефон(ы) отдела продаж
  "geo_lat": 0.0,        // Координата.Широта
  "geo_lng": 0.0,        // Координата.Долгота
  "ax_sign": false       // Знак Аксиомы (true - заверено)
}
...
[
  {
    ...
    "sale": 0,     // Объем продаж
    "head": {
      "id": "",    // Уникальный индентификатор бренда
      "name": ""   // Название бренда
      "sale": 0    // Объем продаж бренда
    }
  },
...
]
